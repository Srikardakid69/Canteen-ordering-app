...
class Indiancuisine extends StatefulWidget {
  const Indiancuisine({super.key});

  @override
  State<Indiancuisine> createState() => _IndiancuisineState();
}

class _IndiancuisineState extends State<Indiancuisine> {
  int _currentIndex = 1;
  ...
  Future<void> loadFavouritesFromFirebase() async {
    ...
    print("⭐ Loaded ${favouriteItemIds.length} favourites.");
  }
    ...
    return Scaffold(
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          final items = MenuDataService.getItemsForStall("Stall 1");

          return Column(
            children: [
              Image.asset(
                'assets/Indian Cuisine Image.png',
                height: 200,
